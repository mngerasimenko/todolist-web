...
**[Попробовать онлайн](https://todo.mngerasimenko.ru)**
...
- Toast-уведомления (Sonner) при создании, удалении, вступлении в список
- Shimmer-скелетоны при загрузке задач и участников
- Плавные анимации появления/удаления задач (Framer Motion)
- Полупрозрачный хедер с backdrop-blur
...
├── components/
│   ├── ui/                — shadcn/ui компоненты (Button, Input, Dialog, Tabs, Skeleton...)
...
Сборка выполняется в CI (`npm run build`), Docker только копирует готовый `dist/`:
